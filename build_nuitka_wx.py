#!/usr/bin/env python3
"""Build script for wxPython version using Nuitka."""
...
def main():
    ...
    main_file = src_dir / "main_wx.py"

    print("=" * 60)
    print("Building wxPython version with Nuitka")
    print("=" * 60)
    ...
    cmd = [
        ...
        "--output-filename=PPTPDFComparator_wx_Nuitka.exe",
    ...
    try:
        ...
        exe_path = dist_dir / "PPTPDFComparator_wx_Nuitka.exe"
        if exe_path.exists():
